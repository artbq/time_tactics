...
ActiveRecord::Schema.define(version: 20170105112537) do
  ...
  create_table "goals", force: :cascade do |t|
    ...
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["activity_id"], name: "index_goals_on_activity_id", using: :btree
  ...
  create_table "plan_activities", force: :cascade do |t|
    ...
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["activity_id"], name: "index_plan_activities_on_activity_id", using: :btree
    t.index ["plan_id"], name: "index_plan_activities_on_plan_id", using: :btree
  end
